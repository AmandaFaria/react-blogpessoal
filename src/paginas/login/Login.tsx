...
function Login() {
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center' className='fundo-login'>
            <Grid alignItems='center' xs={6}>
                <Box paddingX={20}>
                    ...
                    <Box display='flex' justifyContent='center' marginTop={2}>
                        <Box marginRight={1}>
                            <Typography variant='subtitle1' gutterBottom align='center' className='texto3'>Não tem uma conta?</Typography>
                        </Box>
